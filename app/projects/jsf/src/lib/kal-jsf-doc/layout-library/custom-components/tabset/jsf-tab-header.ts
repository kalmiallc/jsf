...
import { ScrollDirection }                                            from '@angular/material';
import { JsfTabLabelWrapper }                                         from './jsf-tab-label-wrapper';
import { JsfInkBar }                                                  from './jsf-ink-bar';
 ...
 */
@Component({
  selector       : 'jsf-tab-header',
  templateUrl    : './jsf-tab-header.html',
  styleUrls      : ['./jsf-tab-header.scss'],
...
export class JsfTabHeader extends _MatTabHeaderMixinBase
  implements AfterContentChecked, AfterContentInit, AfterViewInit, OnDestroy, CanDisableRipple {

  @ContentChildren(JsfTabLabelWrapper) _labelWrappers: QueryList<JsfTabLabelWrapper>;
  @ViewChild(JsfInkBar) _inkBar: JsfInkBar;
  ...
  private _keyManager: FocusKeyManager<JsfTabLabelWrapper>;
