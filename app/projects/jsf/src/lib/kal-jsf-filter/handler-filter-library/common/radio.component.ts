...
@Component({
  selector       : 'jsf-filter-handler-common-radio',
  template       : `
    <div class="handler jsf-filter-handler-common-radio">
...
export class FilterHandlerCommonRadioComponent extends AbstractFilterPropComponent<JsfPropBuilderString> implements OnInit {
