...
@Component({
  selector       : 'jsf-filter-handler-common-button-toggle',
  template       : `
    <div class="handler jsf-filter-handler-common-button-toggle">
...
export class FilterHandlerCommonButtonToggleComponent extends AbstractFilterPropComponent<JsfPropBuilderString> implements OnInit {
